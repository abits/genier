...
# !!! Main.UserApp is configured as an alias for Main.Genier and you might encounter it in some tests
using Main.Genier, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Genier tests" begin
  @includetests ARGS
end
